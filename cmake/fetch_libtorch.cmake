...
set(CUDA_V "none" CACHE STRING "Determines libtorch CUDA version to download (11.8, 12.4, 12.6, 12.8, 12.9, 13.0, 13.2 or none).")
...
elseif(${CUDA_V} STREQUAL "12.9")
    set(LIBTORCH_DEVICE "cu126")
elseif(${CUDA_V} STREQUAL "13.0")
    set(LIBTORCH_DEVICE "cu130")
elseif(${CUDA_V} STREQUAL "13.2")
    set(LIBTORCH_DEVICE "cu132")
else() 
    message(FATAL_ERROR "Invalid CUDA version specified, must be 11.8, 12.4, 12.6, 12.8, 12.9, 13.0, 13.2 or none!")
endif()
